# CatProjectDatabricks

The 'CatProjectDatabricks' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] CatProjectDatabricks_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/CatProjectDatabricks.job.yml). The schedule
